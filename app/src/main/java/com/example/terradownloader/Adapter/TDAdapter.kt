...
//) : RecyclerView.Adapter<RecyclerViewAdapter.DownloadViewHolder>() {
//
...
//        holder.textViewFileStatus.text = downloadModel.mDownloadStatus
...
//        }
//        if (downloadModel.mDownloadStatus.equals("Resume", ignoreCase = true)) {
